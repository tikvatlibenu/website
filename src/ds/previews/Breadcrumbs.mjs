...
const __dsPreview = (() => {
  ...
  // .design-sync/previews/Breadcrumbs.tsx
  ...
  var ArticlePage = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Breadcrumbs, { items: [{ label: "דף הבית", href: "/" }, { label: "בלוג ומאמרים", href: "#blog" }, { label: "איך מדברים עם ילדים על המחלה" }] });
  var TwoLevels = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Breadcrumbs, { items: [{ label: "דף הבית", href: "/" }, { label: "אישורים" }] });
