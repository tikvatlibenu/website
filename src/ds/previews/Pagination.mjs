...
const __dsPreview = (() => {
  ...
  var FirstPage = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Pagination, { page: 1, pageCount: 8, hrefFor: (p) => `#page-${p}` });
  var MiddlePage = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Pagination, { page: 5, pageCount: 12, hrefFor: (p) => `#page-${p}` });
  var LastPage = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Pagination, { page: 4, pageCount: 4, hrefFor: (p) => `#page-${p}` });
