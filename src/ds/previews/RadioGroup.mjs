...
const __dsPreview = (() => {
  ...
  __export(RadioGroup_exports, {
    Cards: () => Cards,
    Default: () => Default,
    HorizontalWithHint: () => HorizontalWithHint
  });
  init_define_import_meta_env();
  ...
  var Cards = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.RadioGroup,
    {
      variant: "card",
      orientation: "horizontal",
      legend: "באיזה תחום תרצו להתנדב?",
      name: "volunteer-area",
      defaultValue: "hospital",
      options: [
        { value: "hospital", label: "ליווי בבית החולים", description: "ביקור שבועי קבוע במחלקה" },
        { value: "home", label: "ליווי בבית", description: "משחק, שיעורי בית, זמן איכות" },
        { value: "events", label: "ימי כיף ואירועים", description: "עזרה בהפקה ובהפעלה" }
      ]
    }
  );
  var HorizontalWithHint = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.RadioGroup,
    {
      orientation: "horizontal",
      legend: "סוג הקבלה",
      name: "receipt",
      hint: "קבלה מוכרת לצורכי מס לפי סעיף 46",
      defaultValue: "private",
      options: [{ value: "private", label: "על שם פרטי" }, { value: "company", label: "על שם חברה" }],
      required: true
    }
  );
